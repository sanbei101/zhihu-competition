...
第五步 分段写结论
每段给一句 conclusion(不超过 70 字),能解释这一段,并点出**代价**:谁得到了什么,谁为此付出了什么。
整段的走向必须在 conclusions 里连贯,把每段横着连起来看,就是这一大段历史的纲要。

第六步 为事件配可选走向(choices)
...
现在请你裁决这一大阶段的历史。
填满 schema:
- beats:2 到 3 段(spanLabel、timeAfter 只需 label 与 elapsed、events 每段 1-3 条、conclusion、metricDeltas),整段首尾相接
